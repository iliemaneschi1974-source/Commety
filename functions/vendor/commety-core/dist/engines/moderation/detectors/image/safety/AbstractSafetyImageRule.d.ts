 ...
 * - la descrizione.
 */
export declare abstract class AbstractSafetyImageRule extends AbstractImageRule {
    /**
     * Restituisce la probabilità da valutare.
     */
    protected abstract valore(analisi: ImageAnalysis): number;
    /**
...
//# sourceMappingURL=AbstractSafetyImageRule.d.ts.map