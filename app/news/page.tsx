        ...
        <Link href="/news/cosa-fare-animale-abbandonato-o-maltrattato" className="group block overflow-hidden rounded-[2rem] border border-white/15 bg-[linear-gradient(135deg,#071f18_0%,#123e2c_48%,#387457_100%)] shadow-[0_22px_55px_rgba(2,16,42,0.3)] transition hover:-translate-y-1 hover:border-white/30">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
            <div className="p-8 sm:p-12">
              <div className="flex size-12 items-center justify-center rounded-2xl bg-emerald-400/15 text-emerald-200"><PawPrint className="size-6" /></div>
              <p className="mt-7 text-sm font-bold uppercase tracking-[0.16em] text-[#b8edca]">23 luglio 2026</p>
              <h2 className="mt-3 max-w-2xl text-3xl font-black leading-tight sm:text-5xl">Cosa fare se vediamo un animale abbandonato o maltrattato</h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-white/75">Numeri utili, procedure corrette e precauzioni per aiutare un animale senza creare altri pericoli.</p>
